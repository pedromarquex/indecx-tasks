...
describe('AppController (e2e)', () => {
  ...
  describe('Users authentication', () => {
    it('should /users/loginenticate a user', async () => {
      const user = {
        name: faker.person.firstName(),
        email: faker.internet.email(),
        password: faker.internet.password(),
    ...
    it('should not /users/loginenticate a user with an invalid email', async () => {
      const user = {
        name: faker.person.firstName(),
        email: faker.internet.email(),
        password: faker.internet.password(),
    ...
    it('should not /users/loginenticate a user with an invalid password', async () => {
      const user = {
        name: faker.person.firstName(),
        email: faker.internet.email(),
        password: faker.internet.password(),
    ...
    it('should not /users/loginenticate a user with an empty email', async () => {
      const user = {
        name: faker.person.firstName(),
        email: faker.internet.email(),
        password: faker.internet.password(),
    ...
    it('should not /users/loginenticate a user with an empty password', async () => {
      const user = {
        name: faker.person.firstName(),
        email: faker.internet.email(),
        password: faker.internet.password(),
    ...
    it('should not /users/loginenticate a user with an empty email and password', async () => {
      const user = {
        name: faker.person.firstName(),
        email: faker.internet.email(),
        password: faker.internet.password(),
    ...
    it('should not /users/loginenticate a user with an invalid email and password', async () => {
      const user = {
        name: faker.person.firstName(),
        email: faker.internet.email(),
        password: faker.internet.password(),
